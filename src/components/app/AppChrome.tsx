...
export function AppChrome({ children }: { children: ReactNode }) {
  return (
    <main className="bg-surface min-h-dvh overflow-hidden text-stone-100">
      ...
      <section className="relative mx-auto flex min-h-dvh w-full max-w-6xl flex-col px-4 py-5 sm:px-6 lg:px-8">
        <Nav />
        {children}
      </section>
    </main>
